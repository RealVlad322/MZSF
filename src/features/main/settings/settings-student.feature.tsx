...
import { DIRECTION_SELECT_ITEMS, GRADE_SELECT_ITEMS, GROUP_SELECT_ITEMS } from './settings.constants';
import $ from './settings.module.scss';
import { MainStore } from '../main.store';

export const SettingsStudentFeature: FC<SettingsStudentFeatureProps> = observer((props) => {
  const {} = props;
...
export interface SettingsStudentFeatureProps {}
